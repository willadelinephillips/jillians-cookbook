  ...
  render() {
    return (
      <div>
        ...
        <img src={lemonylemoncake1} width="60%" alt="lemon cake 1"></img>
        ...
        <img src={lemonylemoncake2} width="60%" alt="lemon cake 2"></img>
        ...
        <img src={lemonylemoncake3} width="60%" alt="lemon cake 3"></img>
        ...
        <img src={lemonylemoncake4} width="60%" alt="lemon cake 3"></img>
